  ...
  <body id="page-top">
    ...
    <section>
        ...
        <form action = "JoinCon.do" method = "post">
            ...
            <input type="radio" name="sex" value="0" id ="man"> 남 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            ...
            <input type="text" class="size" name="year" id="yy" placeholder="년" style = "width:100px"> 
			<input type="text" class="size" name="month" id="mm" min="1" max="12" placeholder="월" style = "width:100px">
		  	<input type="text" class="size" name="day" id="dd" placeholder="일" style = "width:100px">
            ...
            <input type="submit" value="가입하기" class="btn" style="background-color: rgb(142, 201, 224);" id = "joinBtn" disabled = "">
            </p>
        </form>
        </div>
        </div>
