  ...
  <body id="page-top">
      ...
      <div class="container px-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto">
            <a class="nav-link" href = "Logout.jsp" id = "logout" onclick = "deleteJjim(event)">Logout</a></li>
    ...
    <header class="masthead text-center text-white" id = "header">
      ...
      <div class="masthead-content">
        <div class="container px-5">
          <h1 class="masthead-heading mb-0">환영합니다 <%=nick %>님</h1>
    ...
    <section id="scroll">
      <div class="container px-5">
        ...
        <div class="container2">
          <a href="drinkInfo.jsp"><button class="item2" type="button" height="100" width="100">
            <img src="images/soju .png" height="100" width="100" alt="" />소주
          </button></a> 
          <a href="drinkInfo.jsp"><button class="item2" type="button">
          ...
          <a href="imgWorldCup"><button class="item2" type="button">
            <img
    ...
    <section>
        ...
        <div style="overflow: hidden">
          <div class="slide_wrapper">
            <ul class="slides" style="display: inline;">
              <li id = "random0">
            	</li>
            	<li id = "random1">
            	</li>
